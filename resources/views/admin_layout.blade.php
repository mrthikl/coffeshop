...
<link rel="stylesheet" href="{{ asset('asset') }}/css/morris.css" type="text/css"/>
<!-- calendar -->
<link rel="stylesheet" href="{{ asset('asset') }}/css/monthly.css">
<!-- //calendar -->
<!-- //font-awesome icons -->
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{ URL::to('/add-category-new') }}">Thêm loại tin</a></li>
						<li><a href="{{ URL::to('/all-category-new') }}">Danh sách loại tin</a></li>
                    </ul>
                </li>
...
<!-- calendar -->
	<script type="text/javascript" src="{{ asset('asset') }}/js/monthly.js"></script>
